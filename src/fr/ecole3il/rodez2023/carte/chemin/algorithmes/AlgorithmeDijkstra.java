...
/**
 * La classe AlgorithmeDijkstra implémente l'interface AlgorithmeChemin et
 * fournit une implémentation de l'algorithme de Dijkstra pour trouver le chemin
 * le plus court entre deux nœuds dans un graphe pondéré.
 *
